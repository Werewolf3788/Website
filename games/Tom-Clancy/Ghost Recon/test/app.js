 ...
 * Verification: NYT-20260530-0438
 * * NO STRIPPING, NO COMPRESSING, DON'T CHANGE WHAT I DIDN'T SAY TO CHANGE
 * (Corrected Kevin's admin registration email mapping values)
 */
...
// Complete secure registration email lookup maps matrix
const SQUAD_ACCESS_MAPPING = {
    "raykevin71888@gmail.com": { operator: "Werewolf3788", admin: true }, // Corrected admin email mapping parameters cleanly
    "cartnalray9@gmail.com": { operator: "OneLIVIDMAN", admin: false },
    "henchman37@gmail.com": { operator: "DarkTerr", admin: false },
    "bowman4201986@gmail.com": { operator: "DarkTerr", admin: false }
};
...
const BASELINE_SKILLS_BLUEPRINT = {
    ...
    "TROPHY": [
        ...
        /* === MAP BONUS MEDALS === */
        { id: "bm_av_nopain", name: "No Pain Medal", desc: "Location: Agua Verde (Duration increases 50%)", max: 1, sub: "MEDALS" },
        { id: "bm_av_rebels", name: "Trained Rebels Medal", desc: "Location: Agua Verde (Damage increases 5%)", max: 1, sub: "MEDALS" },
        { id: "bm_bv_shield", name: "Aircraft Shield Medal", desc: "Location: Barvechos (10% damage reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_bv_ammo", name: "Ammo Capacity Medal", desc: "Location: Barvechos (Increases max ammo 25%)", max: 1, sub: "MEDALS" },
        { id: "bm_cm_recon", name: "Binocular Recon Medal", desc: "Location: Caimanes (15% efficiency increase)", max: 1, sub: "MEDALS" },
        { id: "bm_es_quiet", name: "Quiet Running Medal", desc: "Location: Espiritu Santo (Reduces noise 10%)", max: 1, sub: "MEDALS" },
        { id: "bm_fd_zoom", name: "Binocular Zoom Medal", desc: "Location: Flor De Oro (Increases max zoom 25%)", max: 1, sub: "MEDALS" },
        { id: "bm_ic_bleed", name: "Bleed Out Time Medal", desc: "Location: Inca Camina (20% time increase)", max: 1, sub: "MEDALS" },
        { id: "bm_it_leader", name: "Born Leader Medal", desc: "Location: Itacua (Efficiency increases 8%)", max: 1, sub: "MEDALS" },
        { id: "bm_it_bullet", name: "Bullet Resistance Medal", desc: "Location: Itacua (5% damage reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_ko_c4", name: "C4 Pack Medal", desc: "Location: Koani (Adds 1 extra C4 pack)", max: 1, sub: "MEDALS" },
        { id: "bm_ko_shield", name: "Car Shield Medal", desc: "Location: Koani (10% damage reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_lc_detect", name: "Detection Medal", desc: "Location: La Cruz (Reduces rate by 5%)", max: 1, sub: "MEDALS" },
        { id: "bm_li_lure", name: "Diversion Lure Medal", desc: "Location: Libertad (Adds 1 extra grenade)", max: 1, sub: "MEDALS" },
        { id: "bm_li_armor", name: "Armor Resistance Medal", desc: "Location: Libertad (Increases by 100%)", max: 1, sub: "MEDALS" },
        { id: "bm_ma_explos", name: "Explosion Resistance", desc: "Location: Malca (15% damage reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_ml_flare", name: "Flare Gun Medal", desc: "Location: Media Luna (Add 2 extra flares)", max: 1, sub: "MEDALS" },
        { id: "bm_ml_mark", name: "Mark Area Medal", desc: "Location: Media Luna (100% efficiency increase)", max: 1, sub: "MEDALS" },
        { id: "bm_mo_range", name: "Range Extender Medal", desc: "Location: Mojocoyo (Horizontal increased 25%)", max: 1, sub: "MEDALS" },
        { id: "bm_mo_flash", name: "Flash Grenade Medal", desc: "Location: Mojocoyo (Adds 2 extra flashbangs)", max: 1, sub: "MEDALS" },
        { id: "bm_mp_speed", name: "Speed Bonus Medal", desc: "Location: Monte Puncu (Adds an extra 20%)", max: 1, sub: "MEDALS" },
        { id: "bm_mp_frag", name: "Frag Grenade Medal", desc: "Location: Monte Puncu (Adds 2 extra grenades)", max: 1, sub: "MEDALS" },
        { id: "bm_my_spread", name: "Hip Fire Spread Medal", desc: "Location: Montuyoc (10% spray reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_oc_mine", name: "Mine Inventory Medal", desc: "Location: Ocoro (Adds 1 extra Mine)", max: 1, sub: "MEDALS" },
        { id: "bm_pu_revive", name: "Revive Speed Medal", desc: "Location: Pucara (30% speed increase)", max: 1, sub: "MEDALS" },
        { id: "bm_re_resil", name: "Squad Resilience Medal", desc: "Location: Remanzo (Resistance increases 5%)", max: 1, sub: "MEDALS" },
        { id: "bm_sm_aim", name: "Stable Aim Medal", desc: "Location: San Mateo (15% movement reduction)", max: 1, sub: "MEDALS" },
        { id: "bm_ta_time", name: "Time to Aim Medal", desc: "Location: Tabacal (Reduces aim time by 10%)", max: 1, sub: "MEDALS" },
        { id: "bm_vv_cool", name: "Cooldown Medal", desc: "Location: Villa Verde (Reduces cooldown by 8s)", max: 1, sub: "MEDALS" },
        { id: "bm_vv_dest", name: "VHC Destruction Medal", desc: "Location: Villa Verde (Increases damage by 20%)", max: 1, sub: "MEDALS" },
...
function evaluateUserPrivileges(user) {
    const email = user.email ? user.email.toLowerCase() : "";
    const accessRules = SQUAD_ACCESS_MAPPING[email];
    
    if (!accessRules) {
        alert("Access Denied: Email not registered under tactical squad maps.");
        auth.signOut();
        return;
    }

    document.getElementById("authOverlay").classList.add("hidden");
    isAdminSession = accessRules.admin === true;
    currentSelectedUser = accessRules.operator;
    ...
    squadRef.on("value", snapshot => {
        ...
        if (directoryData) {
            if (isAdminSession) {
                ...
                renderTargetProfileData(directoryData[currentSelectedUser]);
            }
        }
    });
}
...
function setupInterfaceControls() {
    document.getElementById("googleSignInBtn").addEventListener("click", () => {
        ...
        auth.signInWithPopup(provider).catch(err => console.error("Authentication failed: ", err));
    });
