...
// --- FULL MASTER TROPHY & COLLECTIBLES REGISTRY (UNCOMPRESSED & UNSTRIPPED) ---
const trophyData = [
    // --- BASE GAME ---
...
const appState = {
    ...
    sync: async function() { 
        ...
        try {
            ...
            console.log(`Live broadcast pushed cleanly to Firestore for ${this.activeHunter} (Active Map: ${this.activeMapCategory})`);
        } catch (error) {
